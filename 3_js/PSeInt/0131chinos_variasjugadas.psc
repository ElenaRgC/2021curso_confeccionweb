Algoritmo chinos
	...
	Mientras continuar <> "N" Hacer
		...
		Mientras victorias_jugador <> victorias Y victorias_maquina <> victorias Hacer
		...
		Mientras continuar <> "S" Y continuar <> "N" Hacer
			Escribir "¿Quieres continuar con una nueva partida? (S/N)?"
			leer continuar
