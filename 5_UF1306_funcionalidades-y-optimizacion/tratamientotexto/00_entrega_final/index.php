...
?>
 ...
 --> <input id="nombre" name="nombre" type="text" data-new-placeholder="Nombre" placeholder="Nombre" class="label_better 
 ...
 --> <input id="apellidos" name="apellidos" type="text" data-new-placeholder="Apellidos" placeholder="Apellidos" class="label_better
 ...
 --> <input id="domicilio" data-new-placeholder="Dirección" placeholder="Dirección" name="domicilio" type="text" class="label_better 
 ...
 --> <input id="cpostal" name="cpostal" type="text" data-new-placeholder="Código Postal" placeholder="Código Postal"
            class="label_better
 ...
 --> <input id="correo" name="correo" type="text" data-new-placeholder="Email" placeholder="Email" class="label_better 
            <?php if (isset($errores['correo']))
                echo 'input-error';
                  else if ($correo != '')
                echo 'input-bien';?>" onblur="validarEmail(this);"
            value="<?php if (isset($correo)) echo $correo; ?>" />
        <label for="ingles" class="columna-uno">* Conocimientos de inglés:</label>
        <select name="ingles" id="ingles" class="columna-tres
